...
_SOCIAL = [
    ...
    r'linkedin\.com', r'youtube\.com', r'tiktok\.com', r'threads\.net',
]
_FILES = [r'\.pdf$', r'\.jpg$', r'\.png$', r'\.gif$', r'\.mp4$', r'\.zip$']
_GENERIC = [
    r'/login', r'/signin', r'/signup', r'/subscribe', r'/contact',
    r'/about-us', r'/privacy', r'/terms', r'/cart', r'/checkout',
    r'/shop', r'/careers', r'/jobs', r'/tag/', r'/author/',
    r'/category/$', r'/page/\d+$', r'/search\?', r'/advertise',
    r'/podcast/', r'/webinar/',
] + _SOCIAL + _FILES

_MARRIOTT = [
    r'/category/', r'/tag/', r'/author/', r'/page/', r'/search/',
    r'/subscribe/', r'/media-contacts/',
] + _SOCIAL

_HILTON = [
    r'/team-members/', r'/corporate/', r'/about/',
    r'/responsibility/', r'/investors/',
] + _SOCIAL

_BIZJOURNAL = [
    r'/news/banking', r'/news/technology', r'/news/health-care',
    r'/news/retail', r'/bizwomen/', r'/events/', r'/people/',
    r'/lists/', r'/subscribers', r'/account/',
] + _SOCIAL
...
SOURCE_PATTERNS: Dict[str, SourcePatterns] = {
    ...
    "Marriott News - All Brands": SourcePatterns(
        gold_patterns=[r'news\.marriott\.com/news/\d{4}/\d{2}/', r'news\.marriott\.com/.*-open', r'news\.marriott\.com/.*-debut', r'news\.marriott\.com/.*-resort'],
        block_patterns=_MARRIOTT, link_patterns=[r'/news/\d{4}/\d{2}/'], max_pages=30, source_type="chain_newsroom"),
    "Marriott  - Ritz-Carlton": SourcePatterns(
        gold_patterns=[r'news\.marriott\.com/brands/the-ritz-carlton/', r'news\.marriott\.com/news/\d{4}/\d{2}/.*ritz'],
        block_patterns=_MARRIOTT, link_patterns=[r'/news/\d{4}/\d{2}/'], max_pages=20, source_type="chain_newsroom"),
    "Marriott - St. Regis": SourcePatterns(
        gold_patterns=[r'news\.marriott\.com/brands/st-regis/', r'news\.marriott\.com/news/\d{4}/\d{2}/.*regis'],
        block_patterns=_MARRIOTT, link_patterns=[r'/news/\d{4}/\d{2}/'], max_pages=20, source_type="chain_newsroom"),
    ...
    "Marriott - Tribute Portfolio": SourcePatterns(
        ...
        block_patterns=_MARRIOTT, link_patterns=[r'/news/\d{4}/\d{2}/'], max_pages=15, source_type="chain_newsroom"),
    ...
    "Hilton - Waldorf Astoria": SourcePatterns(
        ...
        block_patterns=_HILTON, link_patterns=[r'/releases/[a-z0-9-]+'], max_pages=20, source_type="chain_newsroom"),
    ...
    "Hyatt Newsroom - All Brands": SourcePatterns(
        ...
        block_patterns=[r'/media-contacts/', r'/about/', r'/brand-pages/', r'/gallery/'] + _SOCIAL,
        link_patterns=[r'/news-releases/[a-z0-9-]+'], max_pages=30, source_type="chain_newsroom"),
    "Hyatt Newsroom - Homepage": SourcePatterns(
        gold_patterns=[r'newsroom\.hyatt\.com/news-releases/[a-z0-9-]+'],
        block_patterns=[r'/media-contacts/', r'/about/'] + _SOCIAL,
        link_patterns=[r'/news-releases/[a-z0-9-]+'], max_pages=20, source_type="chain_newsroom"),
    "IHG News & Media": SourcePatterns(
        ...
        link_patterns=[r'/news-and-media/.*\d{4}'], max_pages=30, source_type="chain_newsroom"),
    "Accor News Stories": SourcePatterns(
        ...
        link_patterns=[r'/news-stories/[a-z0-9-]+'], max_pages=20, source_type="chain_newsroom"),
    "Accor Press Releases": SourcePatterns(
        ...
        link_patterns=[r'/press-releases/[a-z0-9-]+'], max_pages=20, source_type="chain_newsroom"),
    "Ennismore News": SourcePatterns(
        gold_patterns=[r'ennismore\.com/news/[a-z0-9-]+'],
        block_patterns=[r'/brands/', r'/about/', r'/careers/'] + _SOCIAL,
        link_patterns=[r'/news/[a-z0-9-]+'], max_pages=20, source_type="chain_newsroom"),
    "Wyndham Newsroom": SourcePatterns(
        gold_patterns=[r'wyndham.*news.*', r'wyndham.*press.*'],
        block_patterns=_GENERIC, link_patterns=[r'/news/[a-z0-9-]+'], max_pages=20, source_type="chain_newsroom"),
    "Best Western Media Center": SourcePatterns(
        gold_patterns=[r'bestwestern.*media.*'],
        block_patterns=_GENERIC, link_patterns=[r'/media/[a-z0-9-]+'], max_pages=15, source_type="chain_newsroom"),
    ...
    "Four Seasons - New Hotels Page": SourcePatterns(
        ...
        block_patterns=[r'/reservations/', r'/checkout/', r'/spa/', r'/dining/', r'/weddings/'] + _SOCIAL,
        link_patterns=[], max_pages=5, source_type="chain_newsroom"),
    ...
    "Peninsula Hotels News": SourcePatterns(
        ...
        block_patterns=[r'/reservations/', r'/offers/', r'/dining/', r'/spa/'] + _SOCIAL,
        link_patterns=[r'/newsroom/[a-z0-9-]+'], max_pages=15, source_type="chain_newsroom"),
    "Oetker Collection Press": SourcePatterns(
        ...
        link_patterns=[r'/press/[a-z0-9-]+'], max_pages=15, source_type="chain_newsroom"),
    ...
    "Loews Hotels Press": SourcePatterns(
        ...
        link_patterns=[r'/press-room/[a-z0-9-]+'], max_pages=15, source_type="chain_newsroom"),
    "SH Hotels News": SourcePatterns(
        gold_patterns=[r'shhotelsandresorts\.com/.*news.*'],
        block_patterns=[r'/reservations/'] + _SOCIAL,
        link_patterns=[r'/news/[a-z0-9-]+'], max_pages=15, source_type="chain_newsroom"),
    ...
    "Hotel Dive": SourcePatterns(
        ...
        block_patterns=[r'/selfservice/', r'/library/', r'/events/', r'/editors/', r'/signup/', r'cfodive\.com', r'constructiondive\.com', r'retaildive\.com'],
        link_patterns=[r'/news/[a-z0-9-]+/\d+/'], max_pages=50, source_type="industry"),
    "Hotel Dive - News": SourcePatterns(
        gold_patterns=[r'hoteldive\.com/news/[a-z0-9-]+/\d+/'],
        block_patterns=[r'/selfservice/', r'/library/', r'/events/', r'/signup/', r'cfodive\.com', r'constructiondive\.com'],
        link_patterns=[r'/news/[a-z0-9-]+/\d+/'], max_pages=50, source_type="industry"),
    "Hotel Management - News": SourcePatterns(
        gold_patterns=[r'hotelmanagement\.net/.*-open', r'hotelmanagement\.net/.*-hotel', r'hotelmanagement\.net/development/'],
        block_patterns=[r'/white-papers/', r'/events/', r'/subscribe/'] + _SOCIAL,
        link_patterns=[r'/development/[a-z0-9-]+'], max_pages=30, source_type="industry"),
    ...
    "Bisnow Hotels": SourcePatterns(
        ...
        block_patterns=[r'/events/', r'/jobs/', r'/advertise/', r'/subscribe/'] + _SOCIAL,
        link_patterns=[r'/[a-z-]+/news/[a-z0-9-]+'], max_pages=30, source_type="industry"),
    "CoStar Hotels": SourcePatterns(
        gold_patterns=[r'costar\.com/article/\d+'],
        block_patterns=[r'/login', r'/subscribe', r'/pricing'] + _SOCIAL,
        link_patterns=[r'/article/\d+'], max_pages=30, source_type="industry"),
    "Skift - Hotels": SourcePatterns(
        gold_patterns=[r'skift\.com/\d{4}/\d{2}/\d{2}/.*hotel', r'skift\.com/\d{4}/\d{2}/\d{2}/.*resort'],
        block_patterns=[r'/events/', r'/research/', r'/subscribe/', r'/skiftx/'] + _SOCIAL,
    ...
    "Hotel Business": SourcePatterns(
        gold_patterns=[r'hotelbusiness\.com/.*hotel', r'hotelbusiness\.com/.*opening', r'hotelbusiness\.com/.*development'],
        block_patterns=[r'/subscribe/', r'/events/', r'/webinar/', r'/magazine/'] + _SOCIAL,
        link_patterns=[r'/[a-z0-9-]+-hotel', r'/[a-z0-9-]+-opening'], max_pages=30, source_type="industry"),
    "Hotel Interactive": SourcePatterns(
        gold_patterns=[r'hotelinteractive\.com/article/\d+', r'hotelinteractive\.com/.*hotel.*open'],
        block_patterns=[r'/directory/', r'/events/', r'/supplier/'] + _SOCIAL,
        link_patterns=[r'/article/\d+'], max_pages=25, source_type="aggregator"),
    "Hospitality Design": SourcePatterns(
        gold_patterns=[r'hospitalitydesign\.com/.*hotel', r'hospitalitydesign\.com/.*resort', r'hospitalitydesign\.com/.*opening'],
        block_patterns=[r'/events/', r'/awards/', r'/subscribe/', r'/magazine/'] + _SOCIAL,
        link_patterns=[r'/\d{4}/\d{2}/\d{2}/[a-z0-9-]+'], max_pages=20, source_type="industry"),
    "Construction Dive - Hotels": SourcePatterns(
        gold_patterns=[r'constructiondive\.com/news/.*hotel', r'constructiondive\.com/news/.*resort'],
        block_patterns=[r'/selfservice/', r'/library/', r'/events/', r'/signup/'] + _SOCIAL,
        link_patterns=[r'/news/[a-z0-9-]+/\d+/'], max_pages=20, source_type="permit"),

    # ═════════════════════════════════════════════════
    # TRAVEL (4 + 2 NEW)
    # ═════════════════════════════════════════════════
    "Travel + Leisure - Hotels": SourcePatterns(
        gold_patterns=[r'travelandleisure\.com/.*new-hotel', r'travelandleisure\.com/hotels-resorts/.*'],
        block_patterns=[r'/tag/', r'/author/', r'/newsletter/', r'/flights/', r'/cruises/'] + _SOCIAL,
        link_patterns=[r'/hotels-resorts/[a-z0-9-]+'], max_pages=30, source_type=""),
    "Travel Pulse - Hotels": SourcePatterns(
        ...
        link_patterns=[r'/news/[a-z0-9-]+'], max_pages=20, source_type=""),
    "Conde Nast Traveler - Hotels": SourcePatterns(
        gold_patterns=[r'cntraveler\.com/.*hotel.*open', r'cntraveler\.com/.*new.*hotel'],
        block_patterns=[r'/newsletter/', r'/subscribe/', r'/video/', r'/cruises/'] + _SOCIAL,
        link_patterns=[r'/story/[a-z0-9-]+'], max_pages=20, source_type=""),
    "Northstar Meetings - Hotels": SourcePatterns(
        gold_patterns=[r'northstarmeetingsgroup\.com/.*hotel', r'northstarmeetingsgroup\.com/.*opening'],
        block_patterns=[r'/events/', r'/subscribe/'] + _SOCIAL,
        link_patterns=[r'/news/[a-z0-9-]+'], max_pages=20, source_type=""),

    # NEW: Travel sources
    "Travel Weekly - Hotels": SourcePatterns(
        gold_patterns=[r'travelweekly\.com/.*hotel.*open', r'travelweekly\.com/.*resort.*new'],
        block_patterns=[r'/cruises/', r'/tours/', r'/subscribe/', r'/events/'] + _SOCIAL,
        link_patterns=[r'/hotel-news/[a-z0-9-]+', r'/travel-news/[a-z0-9-]+'], max_pages=20, source_type=""),
    "Luxury Travel Advisor": SourcePatterns(
        gold_patterns=[r'luxurytraveladvisor\.com/.*hotel.*open', r'luxurytraveladvisor\.com/.*resort.*new'],
        block_patterns=[r'/subscribe/', r'/events/', r'/awards/'] + _SOCIAL,
        link_patterns=[r'/hotels/[a-z0-9-]+', r'/opening/[a-z0-9-]+'], max_pages=20, source_type=""),
    ...
    "The Orange Studio - Hotel Openings": SourcePatterns(
        ...
        link_patterns=[], max_pages=1, source_type="aggregator"),
    f"New Hotels {_CUR_YEAR}": SourcePatterns(
        ...
        link_patterns=[r'/[a-z0-9-]+-hotel'], max_pages=100, source_type="aggregator"),
    f"New Hotels {_NEXT_YEAR}": SourcePatterns(
        gold_patterns=[rf'/hotel-openings-{_NEXT_YEAR}', r'/[a-z0-9-]+-hotel'],
        block_patterns=[r'/about', r'/contact'],
        link_patterns=[r'/[a-z0-9-]+-hotel'], max_pages=50, source_type="aggregator"),

    # NEW: Additional aggregators
    "Top Hotel Projects": SourcePatterns(
        gold_patterns=[r'tophotelprojects\.com/.*hotel', r'tophotelprojects\.com/.*resort'],
        block_patterns=[r'/login', r'/subscribe', r'/pricing'] + _SOCIAL,
        link_patterns=[r'/en/[a-z0-9-]+'], max_pages=30, source_type="aggregator"),
    "Top Hotel News": SourcePatterns(
        gold_patterns=[r'tophotelnews\.com/.*hotel.*open', r'tophotelnews\.com/.*resort.*new'],
        block_patterns=[r'/subscribe/', r'/advertise/'] + _SOCIAL,
        link_patterns=[r'/[a-z0-9-]+-hotel'], max_pages=25, source_type="aggregator"),
    ...
    "South Florida Biz Journal - Hotels": SourcePatterns(
        ...
        link_patterns=[r'/southflorida/news/\d{4}/\d{2}/\d{2}/.*hotel.*\.html', r'/southflorida/news/\d{4}/\d{2}/\d{2}/.*resort.*\.html'],
        max_pages=25, source_type="florida"),
    "Orlando Biz Journal - Hotels": SourcePatterns(
        ...
        link_patterns=[r'/orlando/news/\d{4}/\d{2}/\d{2}/.*hotel.*\.html', r'/orlando/news/\d{4}/\d{2}/\d{2}/.*resort.*\.html'],
        max_pages=25, source_type="florida"),
    ...
    "Tampa Bay Biz Journal - Hotels": SourcePatterns(
        ...
        link_patterns=[r'/tampabay/news/\d{4}/\d{2}/\d{2}/.*hotel.*\.html', r'/tampabay/news/\d{4}/\d{2}/\d{2}/.*resort.*\.html'],
        max_pages=25, source_type="florida"),
    "Jacksonville Biz Journal - Hotels": SourcePatterns(
        ...
        max_pages=20, source_type="florida"),
    "The Real Deal - South Florida": SourcePatterns(
        gold_patterns=[r'therealdeal\.com/miami/\d{4}/\d{2}/\d{2}/.*hotel', r'therealdeal\.com/miami/\d{4}/\d{2}/\d{2}/.*resort'],
        block_patterns=[r'/new-york/', r'/los-angeles/', r'/chicago/', r'/texas/', r'/subscribe/'] + _SOCIAL,
        link_patterns=[r'/miami/\d{4}/\d{2}/\d{2}/[a-z0-9-]+'], max_pages=25, source_type="florida"),
    "Florida Trend - Hotels": SourcePatterns(
        gold_patterns=[r'floridatrend\.com/.*hotel', r'floridatrend\.com/.*resort', r'floridatrend\.com/.*tourism'],
        block_patterns=[r'/subscribe/', r'/events/', r'/best-companies/'] + _SOCIAL,
        link_patterns=[r'/article/\d+/[a-z0-9-]+'], max_pages=20, source_type="florida"),
    "Commercial Observer - Hotels": SourcePatterns(
        gold_patterns=[r'commercialobserver\.com/\d{4}/\d{2}/.*hotel', r'commercialobserver\.com/\d{4}/\d{2}/.*resort'],
        block_patterns=[r'/events/', r'/subscribe/', r'/commercial-observer-awards/'] + _SOCIAL,
        link_patterns=[r'/\d{4}/\d{2}/[a-z0-9-]+'], max_pages=20, source_type="business"),

    # ═════════════════════════════════════════════════
    # CARIBBEAN (4 + 2 NEW)
    # ═════════════════════════════════════════════════
    "Caribbean Journal - Hotels": SourcePatterns(
        gold_patterns=[r'caribjournal\.com/\d{4}/\d{2}/\d{2}/[a-z0-9-]+-hotel', r'caribjournal\.com/\d{4}/\d{2}/\d{2}/[a-z0-9-]+-resort', r'caribjournal\.com/\d{4}/\d{2}/\d{2}/[a-z0-9-]+-opening'],
        block_patterns=[r'/tag/', r'/author/', r'/destination/', r'-cheap-flights', r'-cruise'],
        link_patterns=[r'/\d{4}/\d{2}/\d{2}/[a-z0-9-]+'], max_pages=30, source_type="caribbean"),
    "Caribbean Journal - Homepage": SourcePatterns(
        ...
        link_patterns=[r'/\d{4}/\d{2}/\d{2}/[a-z0-9-]+'], max_pages=20, source_type="caribbean"),
    "Caribbean Hotel & Tourism Association": SourcePatterns(
        gold_patterns=[r'caribbeanhotelandtourism\.com/.*hotel', r'caribbeanhotelandtourism\.com/\d{4}/\d{2}/\d{2}/'],
        block_patterns=[r'/tag/', r'/about/', r'/membership/'] + _SOCIAL,
        link_patterns=[r'/\d{4}/\d{2}/\d{2}/[a-z0-9-]+/'], max_pages=20, source_type="caribbean"),
    "Sandals Press": SourcePatterns(
        gold_patterns=[r'/press-releases/[a-z0-9-]+'],
        block_patterns=[r'/resorts/', r'/booking/', r'/deals/', r'/weddings/'] + _SOCIAL,
        link_patterns=[r'/press-releases/[a-z0-9-]+'], max_pages=15, source_type="caribbean"),

    # NEW: Caribbean sources
    "Bahamas Ministry of Tourism": SourcePatterns(
        gold_patterns=[r'bahamas\.com/.*press', r'bahamas\.com/.*news'],
        block_patterns=[r'/deals/', r'/islands/', r'/plan-your-trip/', r'/events/'] + _SOCIAL,
        link_patterns=[r'/press/[a-z0-9-]+', r'/news/[a-z0-9-]+'], max_pages=15, source_type="caribbean"),
    "Travel Weekly Caribbean": SourcePatterns(
        gold_patterns=[r'travelweekly\.com/Caribbean-Travel/.*hotel', r'travelweekly\.com/Caribbean-Travel/.*resort'],
        block_patterns=[r'/subscribe/', r'/events/'] + _SOCIAL,
        link_patterns=[r'/Caribbean-Travel/[a-z0-9-]+'], max_pages=20, source_type="caribbean"),

    # ═════════════════════════════════════════════════
    # WIRE SERVICES (NEW - 4)
    # ═════════════════════════════════════════════════
    "PR Newswire - Hotels": SourcePatterns(
        gold_patterns=[r'prnewswire\.com/news-releases/.*hotel', r'prnewswire\.com/news-releases/.*resort', r'prnewswire\.com/news-releases/.*hospitality'],
        block_patterns=_WIRE, link_patterns=[r'/news-releases/[a-z0-9-]+'], max_pages=30, source_type="chain_newsroom"),
    "Business Wire - Hotels": SourcePatterns(
        gold_patterns=[r'businesswire\.com/news/.*hotel', r'businesswire\.com/news/.*resort', r'businesswire\.com/news/.*hospitality'],
        block_patterns=_WIRE, link_patterns=[r'/news/home/\d+'], max_pages=30, source_type="chain_newsroom"),
    "Globe Newswire - Hotels": SourcePatterns(
        gold_patterns=[r'globenewswire\.com/.*hotel', r'globenewswire\.com/.*resort'],
        block_patterns=_WIRE, link_patterns=[r'/news-release/\d+'], max_pages=25, source_type="chain_newsroom"),
    "Google News - Hotel Openings": SourcePatterns(
        gold_patterns=[r'news\.google\.com/.*hotel.*open', r'news\.google\.com/.*resort.*new'],
        block_patterns=[r'/settings/', r'/saved/'] + _SOCIAL,
        link_patterns=[], max_pages=20, source_type="aggregator"),

    # ═════════════════════════════════════════════════
    # REAL ESTATE / DEVELOPMENT (NEW - 3)
    # ═════════════════════════════════════════════════
    "The Real Deal - National": SourcePatterns(
        gold_patterns=[r'therealdeal\.com/\d{4}/\d{2}/\d{2}/.*hotel', r'therealdeal\.com/\d{4}/\d{2}/\d{2}/.*resort'],
        block_patterns=[r'/subscribe/', r'/events/', r'/magazine/'] + _SOCIAL,
        link_patterns=[r'/\d{4}/\d{2}/\d{2}/[a-z0-9-]+'], max_pages=25, source_type="business"),
    "Hospitality Investor": SourcePatterns(
        gold_patterns=[r'.*hospitalityinvestor.*hotel', r'.*hospitalityinvestor.*development'],
        block_patterns=[r'/events/', r'/subscribe/'] + _SOCIAL,
        link_patterns=[r'/news/[a-z0-9-]+'], max_pages=20, source_type="business"),
    "Hotel News Now (CoStar)": SourcePatterns(
        gold_patterns=[r'hotelnewsnow\.com/article/\d+', r'hotelnewsnow\.com/.*hotel.*open'],
        block_patterns=[r'/login', r'/subscribe'] + _SOCIAL,
        link_patterns=[r'/article/\d+'], max_pages=25, source_type="industry"),
}
...
def print_summary():
    ...
    print("-" * 85)
    for name, patterns in SOURCE_PATTERNS.items():
        print(f"{name:<50} {patterns.source_type or '-':<16} {len(patterns.gold_patterns):<6} {len(patterns.block_patterns):<7} {patterns.max_pages:<5}")
    print("-" * 85)
